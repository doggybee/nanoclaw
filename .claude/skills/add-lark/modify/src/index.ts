...
let lark: LarkChannel | undefined;
...
async function main(): Promise<void> {
  ...
  const larkEnv = readEnvFile(['LARK_APP_ID', 'LARK_APP_SECRET']);
  const hasLarkCredentials = !!(larkEnv.LARK_APP_ID && larkEnv.LARK_APP_SECRET);
  ...
  startIpcWatcher({
    ...
    syncGroupMetadata: async (force) => {
      ...
      if (lark) await lark.syncChatMetadata();
    },
    getAvailableGroups,
