...
Fields:
- **Key**: The chat JID (unique identifier for the chat, e.g. `lark:oc_xxx`)
...
- `schedule_task(prompt: "...", schedule_type: "cron", schedule_value: "0 9 * * 1", target_group_jid: "lark:oc_example456")`
